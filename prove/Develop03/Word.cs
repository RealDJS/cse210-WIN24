...
class Word
{
    ...
    // Constructors
    public Word() { this.word = ""; }// Default
    public Word(string word) { this.word = word; }// Paramaterized
    ...
    public string ReplaceLetters()
    {
        ...
        { if (char.IsLetter(letters[i])) { letters[i] = '_'; } }// replaces letter with _ if it is a valid character
