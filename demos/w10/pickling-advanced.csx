...
public class Student
{
    ...
    public override string ToString() { return $"Name={Name}, Age={Age}, GPA={GPA}"; }
}
...
public class ClassRoster
{
    ...
    public ClassRoster() { Students = new List<Student>(); }

    public void PrintRoster()
    { foreach (Student student in Students) { Console.WriteLine($"{student.Name} present!"); } }
}
